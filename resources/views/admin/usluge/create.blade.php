                    ...
                    <form action="{{ route('admin.usluge.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="opis" name="opis" rows="3"
                                class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('opis') }}</textarea>
                        ...
                        <div class="flex items-center">
                            <input id="featured" type="checkbox" name="featured" value="1"
                                class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('featured') ? 'checked' : '' }}>
                            <label for="featured"
